...
//     document.write(`<div class="simpson">${simpson.name}-${simpson.surname}-${simpson.age}-${simpson.info}-<img src="${simpson.photo}" alt="simpson"></div>`)
// }

// for(const simpson of simpsons){
//     document.write(`<div class="simpson"><h2>${simpson.name} ${simpson.surname}. age is - ${simpson.age}</h2>\n<p>${simpson.info}</p>\n<img src="${simpson.photo}" alt="simpson"></div>`)
// }
/*
			Використовуючи данні з масиву, за допомоги document.write та циклу
...
let usersList = [
 ...
 // document.write('<div class="user-list">');
 //
 // for(const userList of usersList){
//    document.write(`<div class="users-box">
//         <div class="user-block">
//             <h2>${userList.id} - ${userList.name} - ${userList.username} </h2>
//                 <h3>${userList.email} - ${userList.phone}</h3>
//                 <div class="address-block">
//                     <p>City - ${userList.address.city}</p>
//                     <p>Street - ${userList.address.street}</p>
//                     <p>Suite - ${userList.address.suite}</p>
//                     <p>Zip code - ${userList.address.zipcode}</p>
//                 </div>
//         </div>
//     </div>`);
//}
